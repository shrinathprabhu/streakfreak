...
export default function Home() {
  ...
  const yearWins = snapshot.entries.filter(
    (e) =>
      ...
      <main className="workspace" id="main">
        <section className="page-heading">
          <div>
            <div className="eyebrow">
              <span /> YOUR EVERYDAY, A LITTLE BETTER
            </div>
            <h1>
              Keep showing up<span>.</span>
            </h1>
            <p>One small thing today. A different you tomorrow.</p>
          </div>
          <button
            disabled={!ready}
        ...
        >
          <div className="view-nav">
            <TabsList variant="line" className="app-tab-list">
                ...
                <div className="heatmap-with-days">
                  ...
                  >
                    {days.map((d, i) => {
                      ...
                      const { done, due, level } = daySummary(
                        displayedHabits,
                        map,
                        d,
                      );
            ...
            <section className="daily-section" ref={dailySection}>
              ...
              <div className="habit-grid">
                {activeHabits.map((h) => {
                  ...
                  const run = habitStreak(h, snapshot.entries, today);
